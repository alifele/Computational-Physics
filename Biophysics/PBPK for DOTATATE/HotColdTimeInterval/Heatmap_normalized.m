...
% amount of injected hot and cold molecules. The color values show the 
% normalized time integreated activity in tumor only. normalized in a sence
% that the TIA map of different time intervals as devided by 10 min time
% interval to comparison
...
% the 1000 min time interval for injection show up to 1.8 more TIA values
